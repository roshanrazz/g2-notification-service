...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<?> NotificationServiceNotFoundExceptions(NotificationServiceException ex, WebRequest request) {
		ErrorResponse errorDetails = new ErrorResponse(HttpStatus.NOT_FOUND, LocalDateTime.now(), ex.getMessage(),
				request.getDescription(false));
	...
	@ExceptionHandler
	public ResponseEntity<ErrorResponse> notificationServiceBadRequestExceptions(Exception ex, WebRequest request) {
